      ...
      $.ajax({
        ...
        success: function (response) {
            $.each(response, function() {
              ...
              tcontent += `<tr><td hidden="true" class="index" scope="row">  </td><td  class="ord">${this.fields.oid}</td> <td>${this.fields.title}</td> <td>
              ...
              </td><td><button class="btn btn-success" id="knowcontent" type="submit">Know Content</button></td><td><span class="navbar-toggler-icon"></span></td></tr>`;
            });
